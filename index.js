...
var qry= 'SELECT DISTINCT C.c_cliente_nombre, F.c_flotilla_nombre, U.c_unidad_nombre, CONCAT("Altotrack") AS "WS" FROM dat_Unidad U, dat_Cliente C, dat_Flotilla F, rel_UnidadFlotilla UF WHERE U.n_estatus_id = 1  AND C.n_estatus_id = 1  AND F.n_estatus_id =1 AND UF.n_estatus_id = 1 AND b_unidad_altotrack = 1  AND C.n_cliente_id = U.n_cliente_id  AND C.n_cliente_id = F.n_cliente_id AND UF.n_unidad_id = U.n_unidad_id  AND UF.n_flotilla_id = F.n_flotilla_id UNION ALL (SELECT DISTINCT C.c_cliente_nombre, F.c_flotilla_nombre, U.c_unidad_nombre, CONCAT("Recurso confiable") AS "WS" FROM dat_Unidad U, dat_Cliente C, dat_Flotilla F, rel_UnidadFlotilla UF WHERE U.n_estatus_id = 1  AND C.n_estatus_id = 1  AND F.n_estatus_id =1 AND UF.n_estatus_id = 1 AND b_unidad_rconfiable = 1  AND C.n_cliente_id = U.n_cliente_id  AND C.n_cliente_id = F.n_cliente_id AND UF.n_unidad_id = U.n_unidad_id  AND UF.n_flotilla_id = F.n_flotilla_id)';
